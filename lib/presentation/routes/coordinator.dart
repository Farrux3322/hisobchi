...
class GlassBottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  ...
                  const Color(0xFFFFF5F7).withValues(alpha: 0.75),
                ],
                stops: const [0.0, 0.5, 1.0],
              ),
              borderRadius: BorderRadius.circular(32.r),
              border: Border.all(
                color: AppTheme.colors.primary.withValues(alpha: .05),
              ),
              boxShadow: [
          BoxShadow(
    ...
    label: 'Mijozlar',
    isSelected: navBarConfig.selectedIndex == 0,
    onTap: () => navBarConfig.onItemSelected(0),
    ),
    _GlassNavItem(
    icon: AppIcons.project,
    label: 'Proyektlar',
    isSelected: navBarConfig.selectedIndex == 1,
    onTap: () => navBarConfig.onItemSelected(1),
    ),
    _GlassNavItem(
    icon: AppIcons.profile,
    label: 'Profile',
    isSelected: navBarConfig.selectedIndex == 2,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            AppTheme.colors.primary.withValues(alpha: .9),
                            AppTheme.colors.primary.withValues(alpha: .8),
                          ],
                        ),
