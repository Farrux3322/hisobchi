...
class PartnerDebtDetailPage extends StatefulWidget {
  ...
  @override
  State<PartnerDebtDetailPage> createState() => _PartnerDebtDetailPageState();
}

class _PartnerDebtDetailPageState extends State<PartnerDebtDetailPage> {
        ...
        body: BlocBuilder<PartnerOperationsBloc, PartnerOperationsState>(
          builder: (context, state) {
            ...
            return RefreshIndicator(
              onRefresh: () async {
                _bloc.add(RefreshOperationsEvent(
                  type: widget.type,
                  currencyTypeId: widget.currencyTypeId,
                  partnerId: widget.partnerId,
                ));
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 36.w,
                      decoration: BoxDecoration(
                        color: isIncoming ? const Color(0xFF22C55E).withOpacity(0.1) : const Color(0xFFEF4444).withOpacity(0.1), 
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            Text(message, textAlign: TextAlign.center, style: TextStyle(fontSize: 14.sp, color: AppTheme.colors.gray.withOpacity(0.6), height: 1.5)),
            SizedBox(height: 32.h),
            SizedBox(
              width: double.infinity,
              child: ElevatedButton(
                onPressed: () {
                  _bloc.add(LoadOperationsEvent(
                    type: widget.type,
                    currencyTypeId: widget.currencyTypeId,
                    partnerId: widget.partnerId,
                  ));
                ...
                child: Text('Qayta urinish', style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w600)),
              ),
            ),
          ],
        ),
    ...
    try {
      ...
      try {
        ...
        if (parts.length == 3) {
          ...
          if (day != null && month != null && year != null) date = DateTime(year, month, day);
        }
      }
