...
class _ProjectEditPageState extends State<ProjectEditPage> {
  ...
  void initState() {
    ...
    _maskFormatter = MaskTextInputFormatter(mask: '+998 (##) ###-##-##', filter: {"#": RegExp(r'[0-9]')}, type: MaskAutoCompletionType.lazy);
  ...
  Future<void> _showDeleteDialog() async {
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: const Text('O\'chirish', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                          ),
                        ),
                      ],
                    ),
    ...
    if (result == true && mounted) {
      // Soft-delete successful: navigate back to project list (pop twice)
      // First pop: close edit page, Second pop: close show page
      Navigator.of(context).pop(true); // Close edit page
      Navigator.of(context).pop(true); // Close show page and return to list
    }
  }
                  ...
                  children: [
                    Container(
                      ...
                      child: isLoading
                          ...
                          : const Icon(Icons.restore, color: Colors.white, size: 40),
                    ),
                    const SizedBox(height: 24),
                    const Text(
                      'Loyihani tiklash',
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: const Text('Tiklash', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                          ),
                        ),
                      ],
                    ),
  ...
  Future<void> _showForceDeleteDialog() async {
    ...
    if (result == true && mounted) {
      // Force delete successful: navigate back to project list (pop twice)
      // First pop: close edit page, Second pop: close show page
      Navigator.of(context).pop(true); // Close edit page
      Navigator.of(context).pop(true); // Close show page and return to list
    }
                    ...
                    children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: const InputDecoration(hintText: 'Masalan: Chilonzor-10 turar joy majmuasi'),
                                      validator: (value) {
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: const InputDecoration(hintText: 'Masalan: Alisher Navoiy'),
                                      validator: (value) {
                                        if (value == null || value.isEmpty) {
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: const InputDecoration(hintText: '+998 (00) 000-00-00'),
                                      validator: (value) {
                                        if (value == null || value.isEmpty) {
                                    ...
                                    TextFormField(
                                      ...
                                      maxLines: 3,
                                      decoration: const InputDecoration(hintText: 'Masalan: Toshkent sh., Chilonzor tumani, Bunyodkor ko\'chasi, 10-uy'),
                                      validator: (value) {
                                        if (value == null || value.isEmpty) {
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: const InputDecoration(hintText: 'Lokatsiya havolasini kiriting...'),
                                    ),
                                                  ...
                                                  child: _selectedImage != null
                                                      ...
                                                      ? ClipRRect(
                                                          ...
                                                          child: CachedNetworkImage(
                                                            ...
                                                            fit: BoxFit.cover,
                                                            placeholder: (context, url) => Center(child: CupertinoActivityIndicator(color: AppTheme.colors.primary)),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const Text('Loyihani saqlash', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ],
                  ),
