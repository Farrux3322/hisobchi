...
class _ProjectCostAddEditPageState extends State<ProjectCostAddEditPage> {
  ...
  void initState() {
    ...
    if (_isEditing) {
      _summaController.text = widget.cost!.summa ?? '';
              ...
              listener: (context, state) {
                if (state.statusAction == Status.success) {
                  Toast.showSuccessToast(
                    message: _isEditing ? 'Chiqim yangilandi' : 'Chiqim yaratildi',
                  );
