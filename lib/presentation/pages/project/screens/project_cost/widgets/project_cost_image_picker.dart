...
class ProjectCostImagePicker extends StatelessWidget {
  final List<ProjectCostImageData> images;
  final Function(int index) onAddImage;
  final Function(int index) onRemoveImage;
  final Function(int index)? onUpdateImage;

  const ProjectCostImagePicker({
    super.key,
  ...
  Widget _buildImagePreview(ProjectCostImageData imageData, int index) {
    return Stack(
      children: [
        ClipRRect(
