...
class AddProjectBottomSheet extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    Function(String projectName, String ownerName, String phone, String address, String location, List<File> images)? onSubmit,
  }) {
    return showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => AddProjectBottomSheet(onSubmit: onSubmit),
    );
  }
}
